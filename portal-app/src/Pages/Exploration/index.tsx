      ...
      <div className="row">
          ...
          <div className="sc-card-product">
            <div className="card-media">
              ...
              <div className="featured-countdown">
                ...
                <span className="js-countdown" data-timer={475665} data-labels=" :  ,  : , : , " />
              </div>
        ...
        <div className="fl-item col-xl-3 col-lg-6 col-md-6 col-12">
          <div className="sc-card-product">
            <div className="card-media active">
              ...
              <div className="featured-countdown">
                <span className="slogan" />
                <span className="js-countdown" data-timer={145545} data-labels=" :  ,  : , : , " />
              </div>
              <div className="button-place-bid">
                <a href="#" data-toggle="modal" data-target="#popup_bid" className="sc-button style-place-bid style bag fl-button pri-3"><span>Place Bid</span></a>
              </div>
        ...
        <div className="fl-item col-xl-3 col-lg-6 col-md-6 col-12">
          <div className="sc-card-product">
            <div className="card-media">
              ...
              <div className="featured-countdown">
                <span className="slogan" />
                <span className="js-countdown" data-timer={1046845} data-labels=" :  ,  : , : , " />
              </div>
              <div className="button-place-bid">
                <a href="#" data-toggle="modal" data-target="#popup_bid" className="sc-button style-place-bid style bag fl-button pri-3"><span>Place Bid</span></a>
              </div>
        ...
        <div className="fl-item col-xl-3 col-lg-6 col-md-6 col-12">
          <div className="sc-card-product">
            <div className="card-media">
              ...
              <div className="featured-countdown">
                <span className="slogan" />
                <span className="js-countdown" data-timer={649881} data-labels=" :  ,  : , : , " />
              </div>
              <div className="button-place-bid">
                <a href="#" data-toggle="modal" data-target="#popup_bid" className="sc-button style-place-bid style bag fl-button pri-3"><span>Place Bid</span></a>
              </div>
        ...
        <div className="col-12">
          <div className="btn-auction center">
            <a href="login.html" id="loadmore" className="sc-button loadmore fl-button pri-3"><span>Load More</span></a>
          </div>
        </div>
      </div>
    </div>
