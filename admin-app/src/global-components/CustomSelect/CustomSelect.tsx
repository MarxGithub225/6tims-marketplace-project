...
function CustomSelect({value = "", label = "", placeholder = "", options = [], onChange = () => {
    ...
    return <div className="w-full" ref={optionsRef}  onClick={() => setSelectOptionOpen(!selectOptionsOpen)}>
        <div className="relative custom-select" style={{width: width, height: height}}>
            ...
            {selectOptionsOpen &&
                <div className={`select-dropdown ${classname}`} style={{width: width ? width : 613}}>
                    {
