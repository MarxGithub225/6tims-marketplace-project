...
export default function ProductPage() {
    ...
    const { data: settingData, isLoading, isFetching, isError }: any =
        useQuery({
            ...
            queryFn: async () => {
                let filter: PaginationOptionProduct = {page, limit, sellerId: sessionInfo?.userInfo.id}
                if(search) {
                ...
                let result: Pagination<Product> = await client.getPublishedProducts(filter)
                if(isSearching) {
                                            ...
                                            <table className='car-settings-table'>
                                                <thead>
                                                    ...
                                                    <th style={{ width: 100 }} className='text-left'>Image</th>
                                                        ...
                                                        <th style={{ width: 50 }} className='text-left'>Coût</th>
                                                        <th style={{ width: 70 }} className='text-left'>Coût promo</th>
                                                        <th style={{ width: 100 }} className='text-left'>Type promo</th>
                                                        <th style={{ width: 50 }} className='text-left'>Ventes</th>
                                                            ...
                                                            <td className='flex items-center justify-center' style={{ width: 100 , height: 89 }}>
                                                                ...
                                                                >{
                                                                    !row?.approved ? 'Unapproved' : (
                                                                        ...
                                                                        row.cancelled ? 'Cancelled':'Cancelled'
                                                                    )
                                                                }</div>
                                                            </td>
