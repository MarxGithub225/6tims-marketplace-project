            ...
            <nav id="main-nav" className="main-nav">
              <ul id="menu-primary-menu" className="menu">
                ...
                <li className="menu-item menu-item-has-children">
                  <a href="#" className='flex items-center'><FrIcon width={19} className="mr-1"/> <span>Français</span></a>
            ...
            <div className="flat-search-btn flex">
              ...
              <div className="admin_active" id="header_admin">
                <div className="header_avatar">
                  ...
                  >
                    {authStatus === AuthStatus.SignedOut && <img className="avatar" src={avatar} alt="avatar" />}
                    ...
                    {authStatus === AuthStatus.SignedIn && <div className="d-flex align-items-center justify-content-between mg-t-5 mg-bt-17">
                      ...
                      <div className="links mt-20">
                        {authStatus === AuthStatus.SignedIn && <a href="/profile">
                          <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {authStatus === AuthStatus.SignedIn && <a className="mt-10" href="/profile">
                        ...
                        {authStatus === AuthStatus.SignedOut && <a className="mt-10" href="/login" id="logout">
