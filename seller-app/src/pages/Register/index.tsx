...
function RegisterPage({ modalOpened, toggleModal}: RegisterPageProps) {
    ...
    return (
        ...
        >
            <div className="relative py-10 w-full h-auto flex justify-center px-4 laptop:px-0 ">
               {!success ? <div className="relative no-scrollbar h-auto w-[100%] intermWidth:w-[992px]"
                >   <div className="absolute top-0 right-6 cursor-pointer step-header-requirements"
                onClick={() => toggleModal()}
                >
                        Quitter
                    </div>
