...
export default class Service {
    ...
    async clickCategory(id: string) {
      return request('PUT', `categories/click/${id}`, this.options)
    }

    async clickSubCategory(id: string) {
      return request('PUT', `categories/click-sub/${id}`, this.options)
    }

    async clickSubCategory2(id: string) {
      return request('PUT', `categories/click-sub-2/${id}`, this.options)
    }
}
