...
function AddSetting({ modalOpened, toggleModal, currentSetting, setCurrentSetting, currentRefuse, upsertSetting, loading}: AddSettingProps) {
                    ...
                    <div className="overflow-hidden " >
                        ...
                        <div className="flex justify-end w-full">
                            <div className="flex item-center space-x-3 actions-buttons">
                                ...
                                >Cancel</div>
                                {!currentRefuse?.validated && <div className={`flex items-center justify-center actions-buttons-submit cursor-pointer`}
                                onClick={() => {
                                    confirmAlert({
